...
**Rising Ruby:** It chats with others using the sounds of its colliding antennae. These sounds are fall hallmarks.

**Sinking Sapphire:** When its antennae hit each other, it sounds like the music of a xylophone.
...
|-------|-------|------|-------|
| ![Kricketot](../assets/sprites/kricketot/front.gif "Kricketot: When its antennae hit each other, it sounds like the music of a xylophone.") | ![Kricketot](../assets/sprites/kricketot/front_shiny.gif "Kricketot: When its antennae hit each other, it sounds like the music of a xylophone.") | ![Kricketot](../assets/sprites/kricketot/back.gif "Kricketot: When its antennae hit each other, it sounds like the music of a xylophone.") | ![Kricketot](../assets/sprites/kricketot/back_shiny.gif "Kricketot: When its antennae hit each other, it sounds like the music of a xylophone.") |

### Female Sprites

| Front | Shiny | Back | Shiny |
|-------|-------|------|-------|
| ![Kricketot](../assets/sprites/kricketot/front_female.gif "Kricketot: When its antennae hit each other, it sounds like the music of a xylophone.") | ![Kricketot](../assets/sprites/kricketot/front_shiny_female.gif "Kricketot: When its antennae hit each other, it sounds like the music of a xylophone.") | N/A | N/A |
...
|------------|---------|--------|--------|-----------|---------|
| #401 | ![bug](../assets/types/bug.png "Bug"){: width="48"} | 0.3 m /<br>1.0 ft | 2.2 kg /<br>4.9 lbs | 1. <span class="tooltip" title="The Pokémon may heal its own status conditions.">Shed Skin</span><br>2. <span class="tooltip" title="Enables a sure getaway from wild Pokémon.">Run Away</span> | #15 |
...
|----------|------------|-----------------|-----------|-------------|------------|
| 1 Def | 255 | 70 | 39 | Medium Slow | <span class="tooltip" title="Held: Each time the holder uses the same move consecutively, its power is increased by another 10% of its original, to a maximum of 100%.">Metronome</span> (5%) |
...
| 1 | <span class="tooltip" title="While resisting, the user attacks the opposing Pokémon. This lowers the Sp. Atk stat of those hit.">Struggle Bug</span> | ![bug](../assets/types/bug.png "Bug"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | 50 | 100 | 20 |
...
| 10 | <span class="tooltip" title="An attack move that cuts down the target’s HP to equal the user’s HP.">Endeavor</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | — | 100 | 5 |
