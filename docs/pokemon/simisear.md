...
|------------------|---------------|
| ![Official Artwork](../assets/sprites/simisear/official.png "Simisear") | ![Shiny Artwork](../assets/sprites/simisear/official_shiny.png "Simisear") |

**Rising Ruby:** A flame burns inside its body. It scatters embers from its head and tail to sear its opponents.

**Sinking Sapphire:** When it gets excited, embers rise from its head and tail and it gets hot. For some reason, it loves sweets.
...
|-------|-------|------|-------|
| ![Simisear](../assets/sprites/simisear/front.gif "Simisear: When it gets excited, embers rise from its head and tail and it gets hot. For some reason, it loves sweets.") | ![Simisear](../assets/sprites/simisear/front_shiny.gif "Simisear: When it gets excited, embers rise from its head and tail and it gets hot. For some reason, it loves sweets.") | ![Simisear](../assets/sprites/simisear/back.gif "Simisear: When it gets excited, embers rise from its head and tail and it gets hot. For some reason, it loves sweets.") | ![Simisear](../assets/sprites/simisear/back_shiny.gif "Simisear: When it gets excited, embers rise from its head and tail and it gets hot. For some reason, it loves sweets.") |
...
|------------|---------|--------|--------|-----------|---------|
| #514 | ![fire](../assets/types/fire.png "Fire"){: width="48"} | 1.0 m /<br>3.3 ft | 28.0 kg /<br>61.7 lbs | 1. <span class="tooltip" title="Makes the Pokémon use a held Berry earlier than usual.">Gluttony</span><br>2. <span class="tooltip" title="Powers up Fire-type moves when the Pokémon is in trouble.">Blaze</span> | N/A |
...
| 1 | <span class="tooltip" title="The user attacks the target with a bursting flame. The bursting flame damages Pokémon next to the target as well.">Flame Burst</span> | ![fire](../assets/types/fire.png "Fire"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | 70 | 100 | 15 |
