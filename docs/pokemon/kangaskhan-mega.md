# Kangaskhan Mega (Parent Pokémon)

| Official Artwork | Shiny Artwork |
|------------------|---------------|
| ![Official Artwork](../assets/sprites/kangaskhan-mega/official.png "Kangaskhan Mega") | ![Shiny Artwork](../assets/sprites/kangaskhan-mega/official_shiny.png "Kangaskhan Mega") |
...
|-------|-------|------|-------|
| ![Kangaskhan Mega](../assets/sprites/kangaskhan-mega/front.gif "Kangaskhan Mega: If you come across a young Kangaskhan playing by itself, you must never disturb it or attempt to catch it. The baby Pokémon’s parent is sure to be in the area, and it will become violently enraged at you.") | ![Kangaskhan Mega](../assets/sprites/kangaskhan-mega/front_shiny.gif "Kangaskhan Mega: If you come across a young Kangaskhan playing by itself, you must never disturb it or attempt to catch it. The baby Pokémon’s parent is sure to be in the area, and it will become violently enraged at you.") | ![Kangaskhan Mega](../assets/sprites/kangaskhan-mega/back.gif "Kangaskhan Mega: If you come across a young Kangaskhan playing by itself, you must never disturb it or attempt to catch it. The baby Pokémon’s parent is sure to be in the area, and it will become violently enraged at you.") | ![Kangaskhan Mega](../assets/sprites/kangaskhan-mega/back_shiny.gif "Kangaskhan Mega: If you come across a young Kangaskhan playing by itself, you must never disturb it or attempt to catch it. The baby Pokémon’s parent is sure to be in the area, and it will become violently enraged at you.") |
...
<audio controls>
<source src='../../assets/cries/kangaskhan-mega/latest.ogg' type='audio/ogg'>
...
<audio controls>
<source src='../../assets/cries/kangaskhan-mega/legacy.ogg' type='audio/ogg'>
  Your browser does not support the audio element.
</audio>
...
|------------|---------|--------|--------|-----------|---------|
| #10039 | ![normal](../assets/types/normal.png "Normal"){: width="48"} | 2.2 m /<br>7.2 ft | 100.0 kg /<br>220.5 lbs | 1. <span class="tooltip" title="Parent and child attack together.">Parental Bond</span> | N/A |
...
| **Min** | 320 | 229 | 184 | 112 | 184 | 184 |
| **Max** | 414 | 383 | 328 | 240 | 328 | 328 |
...
| --- | --- | --- | --- | --- | --- | --- |
| 1 | <span class="tooltip" title="The target is hit with a flurry of punches that strike two to five times in a row.">Comet Punch</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 18 | 85 | 15 |
...
| 7 | <span class="tooltip" title="An attack that hits first and makes the target flinch. It only works the first turn the user is in battle.">Fake Out</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 40 | 100 | 10 |
| 10 | <span class="tooltip" title="The user wags its tail cutely, making opposing Pokémon less wary and lowering their Defense stat.">Tail Whip</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | 100 | 30 |
...
| 19 | <span class="tooltip" title="The user slams the target with a long tail, vines, or a tentacle. The target is hit twice in a row.">Double Hit</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 35 | 90 | 10 |
| 22 | <span class="tooltip" title="As long as this move is in use, the power of rage raises the Attack stat each time the user is hit in battle.">Rage</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 20 | 100 | 20 |
| 25 | <span class="tooltip" title="The target is slugged by a punch thrown with muscle-packed power.">Mega Punch</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 80 | 85 | 20 |
| 31 | <span class="tooltip" title="Looking for an opening, the user strikes consistently. The target’s stat changes don’t affect this attack’s damage.">Chip Away</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 70 | 100 | 20 |
| 34 | <span class="tooltip" title="The target is hit with rhythmically launched punches. This may also leave the target confused.">Dizzy Punch</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 70 | 100 | 10 |
...
| 43 | <span class="tooltip" title="The user endures any attack with at least 1 HP. Its chance of failing rises if it is used in succession.">Endure</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 10 |
| 46 | <span class="tooltip" title="The user rampages and attacks for two to three turns. The user then becomes confused.">Outrage</span> | ![dragon](../assets/types/dragon.png "Dragon"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 120 | 100 | 10 |
| 49 | <span class="tooltip" title="This move enables the user to attack first. This move fails if the target is not readying an attack.">Sucker Punch</span> | ![dark](../assets/types/dark.png "Dark"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 70 | 100 | 5 |
...
| --- | --- | --- | --- | --- | --- |
| <span class="tooltip" title="The target is thrown, and a different Pokémon is dragged out. In the wild, this ends a battle against a single Pokémon.">Circle Throw</span> | ![fighting](../assets/types/fighting.png "Fighting"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 60 | 90 | 10 |
