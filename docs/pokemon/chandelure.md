...
|------------------|---------------|
| ![Official Artwork](../assets/sprites/chandelure/official.png "Chandelure") | ![Shiny Artwork](../assets/sprites/chandelure/official_shiny.png "Chandelure") |

**Rising Ruby:** Being consumed in Chandelure’s flame burns up the spirit, leaving the body behind.

**Sinking Sapphire:** The spirits burned up in its ominous flame lose their way and wander this world forever.
...
|------------|---------|--------|--------|-----------|---------|
| #609 | ![ghost](../assets/types/ghost.png "Ghost"){: width="48"}<br>![fire](../assets/types/fire.png "Fire"){: width="48"} | 1.0 m /<br>3.3 ft | 34.3 kg /<br>75.6 lbs | 1. <span class="tooltip" title="Powers up the Pokémon’s Fire-type moves if it’s hit by one.">Flash Fire</span><br>2. <span class="tooltip" title="Contact with the Pokémon may burn the attacker.">Flame Body</span> | N/A |
...
| 1 | <span class="tooltip" title="This relentless attack does massive damage to a target affected by status conditions.">Hex</span> | ![ghost](../assets/types/ghost.png "Ghost"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | 65 | 100 | 10 |
