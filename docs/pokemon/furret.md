...
|-------|-------|------|-------|
| ![Furret](../assets/sprites/furret/front.gif "Furret: Furret has a very slim build. When under attack, it can slickly squirm through narrow spaces and get away. In spite of its short limbs, this Pokémon is very nimble and fleet.") | ![Furret](../assets/sprites/furret/front_shiny.gif "Furret: Furret has a very slim build. When under attack, it can slickly squirm through narrow spaces and get away. In spite of its short limbs, this Pokémon is very nimble and fleet.") | ![Furret](../assets/sprites/furret/back.gif "Furret: Furret has a very slim build. When under attack, it can slickly squirm through narrow spaces and get away. In spite of its short limbs, this Pokémon is very nimble and fleet.") | ![Furret](../assets/sprites/furret/back_shiny.gif "Furret: Furret has a very slim build. When under attack, it can slickly squirm through narrow spaces and get away. In spite of its short limbs, this Pokémon is very nimble and fleet.") |
...
|------------|---------|--------|--------|-----------|---------|
| #162 | ![normal](../assets/types/normal.png "Normal"){: width="48"} | 1.8 m /<br>5.9 ft | 32.5 kg /<br>71.7 lbs | 1. <span class="tooltip" title="Protects the Pokémon from paralysis.">Limber</span><br>2. <span class="tooltip" title="Prevents other Pokémon from lowering accuracy.">Keen Eye</span> | N/A |
...
|---|----|--------|---------|---------|---------|-------|
| **Base** | 95 | 85 | 65 | 40 | 55 | 100 |
| **Min** | 300 | 157 | 121 | 76 | 103 | 184 |
| **Max** | 394 | 295 | 251 | 196 | 229 | 328 |
...
| 21 | <span class="tooltip" title="The user draws attention to itself, making all targets take aim only at the user.">Follow Me</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 20 |
| 25 | <span class="tooltip" title="The user goes to sleep for two turns. This fully restores the user’s HP and heals any status conditions.">Rest</span> | ![psychic](../assets/types/psychic.png "Psychic"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 5 |
| 29 | <span class="tooltip" title="This move enables the user to attack first. This move fails if the target is not readying an attack.">Sucker Punch</span> | ![dark](../assets/types/dark.png "Dark"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 70 | 100 | 5 |
...
| 45 | <span class="tooltip" title="The user switches places with a party Pokémon in waiting and passes along any stat changes.">Baton Pass</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 40 |
