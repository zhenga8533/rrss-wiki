...
|------------------|---------------|
| ![Official Artwork](../assets/sprites/sewaddle/official.png "Sewaddle") | ![Shiny Artwork](../assets/sprites/sewaddle/official_shiny.png "Sewaddle") |

**Rising Ruby:** This Pokémon makes clothes for itself. It chews up leaves and sews them with sticky thread extruded from its mouth.

**Sinking Sapphire:** Since this Pokémon makes its own clothes out of leaves, it is a popular mascot for fashion designers.
...
|-------|-------|------|-------|
| ![Sewaddle](../assets/sprites/sewaddle/front.gif "Sewaddle: Since this Pokémon makes its own clothes out of leaves, it is a popular mascot for fashion designers.") | ![Sewaddle](../assets/sprites/sewaddle/front_shiny.gif "Sewaddle: Since this Pokémon makes its own clothes out of leaves, it is a popular mascot for fashion designers.") | ![Sewaddle](../assets/sprites/sewaddle/back.gif "Sewaddle: Since this Pokémon makes its own clothes out of leaves, it is a popular mascot for fashion designers.") | ![Sewaddle](../assets/sprites/sewaddle/back_shiny.gif "Sewaddle: Since this Pokémon makes its own clothes out of leaves, it is a popular mascot for fashion designers.") |
...
<audio controls>
<source src='../../assets/cries/sewaddle/latest.ogg' type='audio/ogg'>
...
<audio controls>
<source src='../../assets/cries/sewaddle/legacy.ogg' type='audio/ogg'>
  Your browser does not support the audio element.
</audio>
...
|------------|---------|--------|--------|-----------|---------|
| #540 | ![bug](../assets/types/bug.png "Bug"){: width="48"}<br>![grass](../assets/types/grass.png "Grass"){: width="48"} | 0.3 m /<br>1.0 ft | 2.5 kg /<br>5.5 lbs | 1. <span class="tooltip" title="Powers up Bug-type moves when the Pokémon is in trouble.">Swarm</span><br>2. <span class="tooltip" title="Boosts the Pokémon’s Speed stat in sunshine.">Chlorophyll</span> | N/A |
...
| **Min** | 200 | 99 | 130 | 76 | 112 | 80 |
| **Max** | 294 | 225 | 262 | 196 | 240 | 201 |
...
Sewaddle has no alternate forms.
...
|----------|------------|-----------------|-----------|-------------|------------|
| 1 Def | 255 | 140 | 62 | Medium Slow | <span class="tooltip" title="Held in battle :   When the holder is attracted, it consumes this item to cure the attraction.">Mental Herb</span> (5%) |
...
|------------|------------|--------|-----------|-------|-------|
| 1. Bug | 15 | 50.0% Male<br>50.0% Female | False | Yellow | Armor |
...
| 5 | <span class="tooltip" title="The user bites the target. If the target is holding a Berry, the user eats it and gains its effect.">Bug Bite</span> | ![bug](../assets/types/bug.png "Bug"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 60 | 100 | 20 |
...
| 11 | <span class="tooltip" title="While resisting, the user attacks the opposing Pokémon. This lowers the Sp. Atk stat of those hit.">Struggle Bug</span> | ![bug](../assets/types/bug.png "Bug"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | 50 | 100 | 20 |
| 14 | <span class="tooltip" title="The user endures any attack with at least 1 HP. Its chance of failing rises if it is used in succession.">Endure</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 10 |
| 17 | <span class="tooltip" title="The user weaves a sticky net around the opposing team, which lowers their Speed stat upon switching into battle.">Sticky Web</span> | ![bug](../assets/types/bug.png "Bug"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 20 |
| 20 | <span class="tooltip" title="The user vibrates its wings to generate a damaging sound wave. This may also lower the target’s Sp. Def stat.">Bug Buzz</span> | ![bug](../assets/types/bug.png "Bug"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | 90 | 100 | 10 |
| 23 | <span class="tooltip" title="The user flails about aimlessly to attack. The less HP the user has, the greater the move’s power.">Flail</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | — | 100 | 15 |
...
| <span class="tooltip" title="A two-turn attack. Blades of wind hit opposing Pokémon on the second turn. Critical hits land more easily.">Razor Wind</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | 80 | 100 | 10 |
